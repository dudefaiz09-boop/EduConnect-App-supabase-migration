...
async function loadApp() {
  if (!appPromise) {
    ...
    // @ts-ignore - dist/app.js is generated by apps/functions/build.js.
    appPromise = import('../apps/functions/dist/app.js')
      .then((module) => {
...
export default async function handler(req: IncomingMessage, res: ServerResponse) {
  ...
  try {
    ...
    console.error('[api/index] Failed to load compiled Express app:', error);
