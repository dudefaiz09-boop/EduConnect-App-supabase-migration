...
export const ChatbotPage = () => {
  ...
  const handleFeedback = async (logId: string, feedback: 'helpful' | 'not_helpful') => {
    try {
      await apiClient.request('/api/ai/feedback', {
        method: 'POST',
  ...
  const getRolePrompt = () => {
    switch (role) {
      case 'student':
        return 'Ask about homework, assignments, or study tips...';
      case 'teacher':
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-500 text-sm">
                  I&apos;m your EduConnect AI. I&apos;m here to help you manage your {role} tasks
                  efficiently.
                </p>
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 px-2">
                      <span className="text-[9px] font-bold text-slate-400 uppercase">
                        AI Generated •{' '}
                        {new Date(
                          (log.timestamp as any)?.toDate?.() || log.timestamp
