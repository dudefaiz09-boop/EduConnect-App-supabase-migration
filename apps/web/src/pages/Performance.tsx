...
export const PerformancePage = () => {
  ...
  const loadStudentPerformance = useCallback(async () => {
    try {
      ...
      if (data.length > 0) {
        const ai = await apiClient.request<{ success: boolean; tips: string }>(
          '/api/ai/suggestions',
          {
            method: 'POST',
                ...
                <div className="space-y-4">
                  ...
                  {aiSuggestions.length === 0 && (
                    <p className="text-sm text-indigo-200 italic">
                      Analyzing your scores to generate study tips...
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-2xl bg-red-50 border border-red-100">
                    ...
                    <p className="text-[10px] text-red-600 font-medium">
                      4 students scored below 40% in Math.
                    </p>
                  </div>
          ...
          <div className="lg:col-span-3">
            {view === 'analytics' ? (
              <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm h-[500px]">
                <h3 className="font-bold text-xl text-slate-900 mb-10">
                  Subject Average (Class {selectedClass})
                </h3>
            ...
            >
              ...
              <form onSubmit={handleUpload} className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    type="submit"
                    className="flex-1 bg-indigo-600 text-white py-5 rounded-3xl font-black uppercase tracking-widest text-sm shadow-xl shadow-indigo-100 hover:bg-indigo-700 transition-all"
                  >
                    Import Records
                  </button>
                  <button
